...
setTimeout(() => {a({body: "জান তুমি arif বসের কাছে চলে জাও তোমাকে হট করে দিবে" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "ওই sexy মাইয়া শুনো বস arif তোমাকে খাইতে চায় 😛🍆" + " " + name, mentions: arraytag})}, 12000);
setTimeout(() => {a({body: "উফফ তোমার ফিগার এতো সুন্দর কেন তুমি দেখলেই টুনটুনি দাঁড়িয়ে যায়🤭🤭🤭" + " " + name, mentions: arraytag})}, 15000);
setTimeout(() => {a("Collected From Arif–🤍💚🥀࿐")} , 20000);
